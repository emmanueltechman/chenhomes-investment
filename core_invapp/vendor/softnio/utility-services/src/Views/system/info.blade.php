...
<p class="alert alert-warning fs-13px font-italic">
    {!! '<strong>Please Note:</strong> <br>'.'We will never collect any ' . 'confidential' . ' data such as '. 'transactions' .', emails or usernames.' !!}
</p>
